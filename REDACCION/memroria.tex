...
\subsection{Inestabilidad de Weibel en el modelo 1D2V relativista}
\label{sec:weibel}
...
Las Figuras~\ref{fig:weibel_fpx} y~\ref{fig:weibel_fpy} muestran cómo la
...
\subsection{Resolución por métodos Monte Carlo: esquema PIC (Particle-in-Cell)}
\label{sec:pic}
